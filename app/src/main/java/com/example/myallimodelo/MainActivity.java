package com.example.myallimodelo;
...
import com.example.myallimodelo.ml.AllissonMo;
...
public class MainActivity extends AppCompatActivity implements OnSuccessListener<Text>, OnFailureListener {
    ...
    public void PersonalizedModel(View v){
        try {
            ...
            String[] etiquetas = {" Auditorio ",  "Polideportivo" ,"2Baños" , "Parqueadero", "Centro medico" , "Laboratorio industrial" , "Comedor", "Laboratorio acuicultura" ,
                    "FCIP" , "Laboratorio agroindustrial", "FCI"};

            AllissonMo model = AllissonMo.newInstance(getApplicationContext());
            TensorBuffer inputFeature0 = TensorBuffer.createFixedSize(new int[]{1, 224, 224, 3}, DataType.FLOAT32);
            inputFeature0.loadBuffer(convertirImagenATensorBuffer(mSelectedImage));

            AllissonMo.Outputs outputs = model.process(inputFeature0);
